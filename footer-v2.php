                           ...
                           <div class="footer__widget footer__widget-2 footer-col-2-1 mb-50">
                              ...
                              <div class="footer__widget-content">
                                 <div class="footer__widget-info">
                                    <p>মডেল টেস্ট দিলে তৈরি হয় পরীক্ষা দেওয়ার এবং পরীক্ষার ‘সময় ব্যবস্থাপনা’র
একটি সহজাত অভ্যাস। পাশাপাশি দূর হয় পরীক্ষা-ভীতিও।</p>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-5">
                           <div class="footer__widget footer__widget-2 mb-50 footer-col-2-2">
                              <div class="footer__widget-content">
                                 <ul>
                                    <li>
                                       <a href="https://www.prothomalo.com/collection/video-education">পড়াশোনার ভিডিও</a>
                                    </li>
                                    <li>
                                       <a href="https://www.prothomalo.com/topic/নোটিশ-ও-অন্যান্য">নোটিশ ও অন্যান্য</a>
                                    </li>
                                    <li>
                                       <a href="https://www.prothomalo.com/topic/গণিত-ইশকুল">গণিত ইশকুল</a>
                                    </li>
                                    <li>
                                       <a href="https://www.prothomalo.com/topic/এইচএসসি-পরীক্ষা">এইচএসসি</a>
                                    </li>
                        ...
                        <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-3 col-sm-5">
                           <div class="footer__widget footer__widget-2 mb-50 footer-col-2-3">
                              <div class="footer__widget-content">
                                 <ul>
                                    <li>
                                       <a href="https://www.prothomalo.com/topic/এসএসসি-পরীক্ষা">এসএসসি</a>
                                    </li>
                                    <li>
                                       <a href="https://www.prothomalo.com/topic/অষ্টম-শ্রেণি">অষ্টম শ্রেণী</a>
                                    </li>
                                    <li>
                                       <a href="https://www.prothomalo.com/topic/পঞ্চম-শ্রেণি">পঞ্চম শ্রেণী</a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
