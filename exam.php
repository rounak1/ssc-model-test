  ...
  <div class="container">
    ...
    ?>      
                ...
                <?php } else { ?> 
                    ...
                    <div class='alert alert-primary text-center'>দুঃখিত! এই মডেল টেস্টটি পাওয়া যায়নি অথবা এখনো প্রকাশিত হয়নি। <br/>যথাযথ মডেল টেস্ট সিলেক্ট করতে ড্যাসবোর্ড থেকে রুটিন দেখে নাও।</div>
